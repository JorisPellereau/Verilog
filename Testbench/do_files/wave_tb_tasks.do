...
add wave -noupdate -radix hexadecimal -childformat {{{/tb_top/s_check_level_if/check_signals[0]} -radix hexadecimal} {{/tb_top/s_check_level_if/check_signals[1]} -radix hexadecimal} {{/tb_top/s_check_level_if/check_signals[2]} -radix hexadecimal} {{/tb_top/s_check_level_if/check_signals[3]} -radix hexadecimal} {{/tb_top/s_check_level_if/check_signals[4]} -radix hexadecimal}} -expand -subitemconfig {{/tb_top/s_check_level_if/check_signals[0]} {-radix hexadecimal} {/tb_top/s_check_level_if/check_signals[1]} {-radix hexadecimal} {/tb_top/s_check_level_if/check_signals[2]} {-radix hexadecimal} {/tb_top/s_check_level_if/check_signals[3]} {-radix hexadecimal} {/tb_top/s_check_level_if/check_signals[4]} {-radix hexadecimal}} /tb_top/s_check_level_if/check_signals
